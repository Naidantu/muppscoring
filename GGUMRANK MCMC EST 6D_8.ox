...
decl parinits="ParInits68.txt";	  //File containing initial values for alpha | delta | tau;
...
decl EstPar=1;	//1=Estimate statement parameters; 0=Do not estimate parameters (uses the specified initial parameter file for scoring only)
...
decl outputparresults=1;		//1=Output statement parameter results to file, 0=Do not output;		  
decl parresultfile="0.3DirectParResults68800rep20.txt";  //File name for statement parameter results
...
decl thetafile="0.3DirectThetaEsts68800rep20.txt";  //File name for estimated thetas
...
decl corr=correlation(genpar~parmeans);
...
decl finala = parmeans[][0];
decl finald = parmeans[][1];
decl finalt = parmeans[][2];
if(choice==0) {
